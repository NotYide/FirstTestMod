...
public class ModBlocks {
	public static final Block CUSTOM_ORE = registerBlock("custom_ore", new Block(AbstractBlock.Settings.create().strength(4f).requiresTool().sounds(BlockSoundGroup.AMETHYST_BLOCK)));
